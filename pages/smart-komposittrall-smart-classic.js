...
const smartclassic = () => {
  return (
    <Layout pageTitle="smart-terrassebrædder-smart-classic">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="smart-terrassebrædder-smart-classic" crumbTitle="smart-terrassebrædder-smart-classic" />
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                        <div className="project-details">
                          <h2>SMART ™ Terrassebrædder System – Smart Classic ™</h2>
                          <strong>utroligt valg med utrolig skønhed</strong>
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">

                              <strong>På grund af det unikke sammenlåsningssystem, hulfri overflade, er SMART ™ Decking System et godt valg for familier. Det er designet til maksimal holdbarhed. Det modstår falmning, pletter, skimmelsvamp og vil ikke rådne, knække eller vride sig. Det er også insektsikkert og splinterfrit, hvilket gør det sikrere og mere behageligt for familier med børn og kæledyr.</strong><br/>
                              Vores SMART Classic ™ pyntede er inspireret af naturlige mineraler og jordpigmenter med en æstetisk appel af kontinuerlige og strukturerede riller. Farvepaletten er rig og levende – og foretrækkes af husejere og arkitekter frem for andre pyntematerialer. Hver omhyggeligt formuleret skygge inkluderer attraktive multikromatiske toner og striber. SMART Classic ™ kompositplanker er sikre at gå på med bare fødder<br/>
                              SMART Classic ™ -kompositplader installeres uden klips og fastgøres til bjælkerne ved hjælp af skruer gennem de præfabrikerede lange fastgørelses- og drænhuller.<br/>
                              Ved at bruge SMART ™ Decking System kan du oprette en helt lukket terrasseoverflade, der ikke tillader snavs at falde ned eller ukrudt vokse op.
                              <div>
                                <ul>
                                ...
                                <table width="100%">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td align="left">Skridsikker, ribbet, rig, multi-tonet farver</td>
                                    </tr>
                                    <tr>
                              ...
                              <div className="row mt-60">
                                ...
                                <Grid container spacing={3}>
                                  ...
                                  <Grid item xs={6} sm={3} lg={6}>
                                    <a target="_blank" href="/pdfs/smart-classic-deck-english%20(1).pdf" className="thm-btn"  >Installationsguide</a>
                                  </Grid>
                                  <Grid item xs={8} sm={6} lg={8}>
                                    <a target="_blank" href="/pdfs/smart-classic-deck-english-1.pdf" className="thm-btn" >aluminium installation</a>
                                  </Grid>
                                </Grid>
                              </div>
                            </div>
                      ...
                      <div className="col-12 mb-30 mt-20" >
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="/pdfs/smart-classic-deck-english%20(1).pdf">
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="/pdfs/smart-classic-deck-english-1.pdf">
                              <img src={pdfimg6} className="img-fluid" alt="" />
                            </a>
                          </Grid>
                          <Grid item xs={6} sm={2}>
