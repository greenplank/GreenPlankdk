...
const smartregular = () => {
  return (
    <Layout pageTitle="smart-terrassebrædder-smart-regular">
      <HeaderTwo />
      <StickyHeader />
      <PageHeader title="smart-terrassebrædder-smart-regular" crumbTitle="smart-terrassebrædder-smart-regular" />
                    ...
                    <div className="row">
                      ...
                      <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                        <div className="project-details">
                          <h2>SMART™ terrassebrædder – Smart Regular™</h2>
                          ...
                          <div class="et_pb_text_inner">
                            <div class="ce_text block">
                              ...
                              De brede og lige riller på SMART Regular ™ -kompositplanker danner et jævnt mønster på overfladen, som ikke kun giver et smukt bangkirai-træudseende, men en effektiv vandudledning og en skridsikker slidbaneoverflade for god trækkraft i våde områder såsom omkring bassiner . SMART ™ kompositplanker er sikre at gå på med bare fødder.<br />
                              Vores SMART Regular ™ pyntede er inspireret af naturlige mineraler og jordpigmenter, farvepaletten er rig og levende – og foretrækkes af husejere og arkitekter frem for andre pyntematerialer. Hver omhyggeligt formuleret skygge inkluderer attraktive multikromatiske toner og striber for at give et moderne look og en naturlig følelse.<br />
                              SMART Regular ™ -kompositplader installeres uden klips og fastgøres til bjælkerne ved hjælp af skruer gennem de præfabrikerede lange fastgørelses- og drænhuller.<br />
                                ...
                                <table width="100%">
                                  <tbody>
                                    <tr>
                                      ...
                                      <td align="left">Rige, flerfarvede farver, skridsikker</td>
                                    </tr>
                                    <tr>
                              ...
                              <div className="row section-space--top--60">
                                ...
                                <Grid container spacing={3}>
                                  ...
                                  <Grid item xs={6} sm={3} lg={6}>
                                    <a target="_blank" href="/pdfs/smart-regular-english.pdf" className="thm-btn"  >Installationsguide</a>
                                  </Grid>
                                  <Grid item xs={8} sm={6} lg={8}>
                                    <a target="_blank" href="/pdfs/smart-regular-english-1.pdf" className="thm-btn" >aluminium installation</a>
                                  </Grid>
                                </Grid>
                              </div>
                            </div>
                      ...
                      <div className="col-12 mb-30 mt-20" >
                        ...
                        <Grid container spacing={3}>
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="/pdfs/smart-regular-english.pdf">
                          ...
                          <Grid item xs={6} sm={2}>
                            <a target="_blank" href="/pdfs/smart-regular-english-1.pdf">
                              <img src={pdfimg6} className="img-fluid" alt="" />
                            </a>
                          </Grid>
                          <Grid item xs={6} sm={2}>
