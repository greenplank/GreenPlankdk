  ...
  return (
    <>
      ...
      <Layout pageTitle="primacap-fasadpanel-gp801">
        <HeaderTwo />
        <StickyHeader />
        <PageHeader title="Primacap - GP801" crumbTitle="gp801" />
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-12 col-12 mb-80 pl-30 pl-sm-15 pl-xs-15">
                          <div className="project-details">
                            <h2>PRIMA CAP ™ facadebeklædnings panel – GP801
                            </h2>
                            ...
                            <div class="et_pb_text_inner">
                              <div class="ce_text block">
                                ...
                                <p>
                                  PRIMA CAP ™ GP801 kompositbrede facadeplader installeres normalt i vandret retning uden klemmer og fastgøres til understøtningerne ved hjælp af skruer gennem de præfabrikerede lange fastgøringshuller.
                                  ...
                                  <table width="100%">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left"> ca. 6.60 meter til 1 m²</td>
                                      </tr>
                                      <tr>
